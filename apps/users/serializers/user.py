...
from users.serializers.role import RoleModelSerializer
...
class UserModelSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        representation['role'] = RoleModelSerializer(instance.role.all(), many=True).data
        representation['photo'] = FileSerializer(context=self.context, required=False).data
